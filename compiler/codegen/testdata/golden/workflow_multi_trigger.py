...
daily = _orca__block("cron", 
    schedule="0 9 * * *",
)

hooks_in = _orca__block("webhook", 
    path="/hooks/in",
)
...
pipeline.add_node("analyst", _orca__node_analyst)
...
pipeline.add_edge("hooks_in", "analyst")
